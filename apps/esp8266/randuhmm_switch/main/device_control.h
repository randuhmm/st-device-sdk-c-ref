...
//#define CONFIG_TARGET_ESP8266_SONOFF_SWITCH
...
#elif defined(CONFIG_TARGET_ESP8266_SONOFF_SWITCH)

#define GPIO_OUTPUT_NOTIFICATION_LED 13
#define GPIO_INPUT_BUTTON 0

#define GPIO_OUTPUT_MAINLED 12
#define GPIO_OUTPUT_MAINLED_0 14 /* use as ground */

#define GPIO_OUTPUT_NOUSE1 16
